...
function enqueue_custom_styles() {
    ...
    wp_enqueue_style('custom-photo-block-css', get_template_directory_uri() . '/css/photo-block.css', array(), '1.0', 'all');
...
function enqueue_select2_jquery() {
    ...
    wp_enqueue_script('select2-js', '/js/select2.js', array('jquery'), null, true);
}
...
function load_more_posts() {
    ...
    if( 
        ...
        if( 
            ...
            // Création d'une requête pour filtrer par catégorie
            $args_custom_posts['tax_query'] = array(
                array(
                    'taxonomy' => 'categorie',
                    'field'    => 'slug',
        ...
        if(
            ...
            // Création d'une requête pour filtrer par format
            $args_custom_posts['tax_query'] = array(
                array(
                    'taxonomy' => 'format',
                    'field'    => 'slug',
