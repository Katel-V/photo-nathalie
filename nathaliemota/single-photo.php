    ...
    <div class="zone-contenu mobile-first">
        ...
        <div class="left-container">
            <div class="left-contenu">
                ...
                // Format de la photo - récupère les termes de format associés à la photo actuelle.
                ...
                // Type de la photo - récupère la valeur du champ personnalisé 'type' et l'affiche s'il existe.
                $type = get_field('type');
                if ($type) {
                    echo '<p>Type : ' . esc_html($type) . '</p>';
                }

                // L'année de de la photo - récupère l'année de le photo et l'affiche si elle existe.
        ...
        <div class="right-container">
            <?php if (has_post_thumbnail()) : ?>
                ...
                <i class="fa-light fa-expand-alt fullscreen-icon"></i>  <!-- Fullscreen icon -->
            <?php endif; ?>
